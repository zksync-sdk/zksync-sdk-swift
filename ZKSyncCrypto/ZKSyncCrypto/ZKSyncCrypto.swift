...
public class ZKSyncCrypto: NSObject {
    ...
    static public func generatePrivateKey(seed: Data) -> Result<ZKPrivateKey, ZKSyncCryptoError> {
    ...
    static public func getPublicKey(privateKey: ZKPrivateKey) -> Result<ZKPackedPublicKey, ZKSyncCryptoError> {
    ...
    static public func getPublicKeyHash(publicKey: ZKPackedPublicKey) -> Result<ZKPublicHash, ZKSyncCryptoError> {
    ...
    static public func signMessage(privateKey: ZKPrivateKey, message: String) -> Result<ZKSignature, ZKSyncCryptoError> {
    ...
    static public func signMessage(privateKey: ZKPrivateKey, message: Data) -> Result<ZKSignature, ZKSyncCryptoError> {
        return privateKey.withUnsafeBytes { bufferRaw in
