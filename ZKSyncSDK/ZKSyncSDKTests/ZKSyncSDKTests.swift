...
class ZKSyncSDKTests: XCTestCase {
    ...
    func testErronOnSeedTooShort() {
        ...
        guard case let .error(error) = ZKSyncSDK.generatePrivateKey(seed: seed) else {
    ...
    func testErrorOnMusigMessageTooLong() {
        ...
        guard case let .error(error) = ZKSyncSDK.signMessage(privateKey: privateKey, message: message) else {
